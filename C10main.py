...
if len(analysis_stats['loss_values']) > 0:
    ...
    # Save loss plot
    loss_plot_filename = f"{timestamp}_cifar10_loss_curve.png"
    ...
    if analyze_spectral_density:
        ...
        if num_plots_to_show <= 0: print("No density data points available.")
            ...
            if num_plots_to_show <= 0:
                ...
                fig.suptitle(f"{plot_title_prefix}CIFAR-10 Spectral Density Evolution ({analysis_stats['analysis_type']})\n{matrix_title_str}\n{layer_info_str}", fontsize=14)
                ...
                # Save plot to file
                plot_filename = f"{timestamp}_cifar10_spectral_density.png"
                plot_path = os.path.join(plots_dir, plot_filename)
                plt.savefig(plot_path, dpi=300, bbox_inches='tight')
                print(f"Saved CIFAR-10 spectral density plot to: {plot_path}")
        ...
        fig.suptitle(f"{plot_title_prefix}CIFAR-10 Level Spacing Analysis ({analysis_stats['analysis_type']})\n{matrix_title_str}\n{layer_info_str}", fontsize=14)
        ...
        # Save plot to file
        plot_filename = f"{timestamp}_cifar10_level_spacing.png"
        plot_path = os.path.join(plots_dir, plot_filename)
        plt.savefig(plot_path, dpi=300, bbox_inches='tight')
        print(f"Saved CIFAR-10 level spacing plot to: {plot_path}")
